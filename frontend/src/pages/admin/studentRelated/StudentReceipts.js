...
const StudentReceipts = () => {
    ...
    const [receipts, setReceipts] = useState([]); // Siempre asegurando que sea un array
        ...
        const fetchReceipts = async () => {
            try {
                ...
                if (Array.isArray(response.data)) {
                    ...
                    console.error('Recibos no son un arreglo:', response.data);
                    setReceipts([]);
                }
            } catch (error) {
                ...
                setShowPopup(true);
                setReceipts([]); // Aseguramos que sea un array vacío en caso de error
            }
        };
