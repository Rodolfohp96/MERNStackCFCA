                                ...
                                <Stack spacing={3}>
                                    {
                                        ...
                                        <FormControl fullWidth>
                                            <InputLabel id="demo-simple-select-label">Seleccionar Asignatura</InputLabel>
                                            <Select
                                            ...
                                            >
                                                {subjectsList ?
                                                    ...
                                                    :
                                                    <MenuItem value="Seleccionar Asignatura">
                                                        Agregar Asignaturas para Asistencia
                                                    </MenuItem>
                                                }
                                            </Select>
                                        </FormControl>
