    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Student/receipts"> {/* Nueva entrada en el menú */}
                    <ListItemIcon>
                        <ReceiptIcon color={location.pathname.startsWith("/Student/receipts") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
