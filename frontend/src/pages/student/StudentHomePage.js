...
const StudentHomePage = () => {
    ...
    const { receipts } = useSelector((state) => state.student);
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={3} lg={3}>
                        <StyledPaper>
                            ...
                            <Data start={0} end={receipts.length} duration={4} />
                        </StyledPaper>
                    </Grid>
                    <Grid item xs={12} md={4} lg={3}>
                        <ChartContainer>
                            {
                                response ?
                                    <Typography variant="h6">No se encontraron registros de asistencia</Typography>
                                    :
                                    <>
                                        {loading
                                            ? (
